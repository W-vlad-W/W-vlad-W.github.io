...
jQuery(document).ready(function(){
    ...
    jQuery('#woocommerce-product-data').on('change','._skybox_file_field', function(e) { 
        ...
        var model_id = getModelID(jQuery(this));
        console.log('skybox - ' + model_id + ' - ' + jQuery(this).val());
    ...
    jQuery('#woocommerce-product-data').on('change','._ar_hide_dimensions', function(e) {
        ...
        var element = element_checkbox.parentElement;
    ...
    jQuery('#woocommerce-product-data').on('change','._ar_resizing', function(e) {
        var model_id = getModelID(jQuery(this));
        var element = document.getElementById("model_" + model_id);
    ...
    jQuery('#woocommerce-product-data').on('click', '.wctoggle-model-fields', function(event) {
        ...
        // Find all instances of GLB and USDZ elements within the document
        var glb_elems = jQuery('.glb-file-container');
        var usdz_elems = jQuery('.usdz-file-container');
    
        if (jQuery(this).data('status') === 'hidden') {
            // Remove 'nodisplay' class to show all elements
            usdz_elems.removeClass('nodisplay');
            glb_elems.removeClass('nodisplay');
    
            // Update button status and text
            jQuery(this).data('status', 'visible');
            jQuery(this).text('Hide Model Fields');
        } else {
            // Add 'nodisplay' class to hide all elements
            usdz_elems.addClass('nodisplay');
            glb_elems.addClass('nodisplay');
