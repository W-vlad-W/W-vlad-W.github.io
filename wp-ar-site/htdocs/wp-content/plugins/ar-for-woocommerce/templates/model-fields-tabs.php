            <!-- Tab links -->
                ...
                ?>
                <div class="ar_tab">
                  <button class="ar_tablinks <?php echo esc_html($files_tab); ?>" onclick="ar_open_tab(event, 'model_files_content', 'model_files_tab')" id="model_files_tab" type="button"><?php echo esc_html(__( 'Model Files', 'ar-for-woocommerce'));?><span style=" vertical-align: super;font-size: smaller;"> </span></button>
                  <button class="ar_tablinks <?php echo esc_html($gallery_tab); ?>" onclick="ar_open_tab(event, 'asset_builder_content', 'asset_builder_tab')" id="asset_builder_tab" type="button"><?php echo esc_html(__( '3D Gallery Builder', 'ar-for-woocommerce'));?><span style=" vertical-align: super;font-size: smaller;"> </span></button>
                   <button class="ar_tablinks" onclick="ar_open_tab(event, 'user_upload_content', 'user_upload_tab')" id="user_upload_tab" type="button"><?php echo esc_html(__('User Upload', 'ar-for-woocommerce'));?><span style=" vertical-align: super;font-size: smaller;"> </span></button>
                   <button class="ar_tablinks" onclick="ar_open_tab(event, 'instructions_content','instructions_tab')" id="instructions_tab" type="button"><?php echo esc_html(__( 'Shortcodes', 'ar-for-woocommerce'));?><span style=" vertical-align: super;font-size: smaller;"> </span></button>
                  <a href="https://armodelshop.com?from_plugin=true&redirect_url=<?php echo esc_url($encoded_redirect_url); ?>" target="_blank"><button class="ar_tablinks" id="support_tab" type="button"> <?php echo esc_html(__( 'AR Model Shop', 'ar-for-woocommerce'));?><span style=" vertical-align: super;font-size: smaller;">&#8599;</span></button></a>
                <a href="https://augmentedrealityplugins.com/support/" target="_blank"><button class="ar_tablinks" id="support_tab" type="button"> <?php echo esc_html(__( 'Support','ar-for-woocommerce'));?><span style=" vertical-align: super;font-size: smaller;">&#8599;</span></button></a>
                </div>
                ...
                <div>
                	<div class="ar_model_files_advert hide_on_devices">
                	    <center>
                    	    ...
                    	    <h4><?php echo esc_html(__( 'Hang your artwork in AR with just a photo!', 'ar-for-woocommerce'));?></h4>
                    	    <button type="button" id="asset_builder_button" onclick="ar_open_tab(event, 'asset_builder_content', 'asset_builder_tab');/*ar_activeclass('asset_builder_tab');*/" class="button ar_admin_button" style="margin-right:20px"><?php echo esc_html(__( '3D Gallery Builder', 'ar-for-woocommerce'));?></button>
                	...
                	<div class="ar_model_shop_advert hide_on_devices">
                	    <center>
                	        ...
                	        <h4><?php echo esc_html(__( 'Purchase an', 'ar-for-woocommerce')).' <b>AR Model</b> '.esc_html(__( 'for your site.', 'ar-for-woocommerce')); ?></h4>
                	        <button 
                    ...
                    <div class="ar_model_files_fields">
                        <div style="width:48%; float:left;padding-right:10px; position:relative;">
                            ...
                            <center>
                            <strong><?php echo esc_html(__(  'GLTF/GLB 3D Model', 'ar-for-woocommerce'));?></strong> <br><br>
                            ...
                            <div align="center">                            
                                <input type="hidden" pattern="https?://.+" title="<?php echo esc_html(__( 'Secure URLs only', 'ar-for-woocommerce')); ?> https://" placeholder="https://" name="_glb_file" id="_glb_file" class="regular-text ar_input_field" value="<?php echo esc_html(get_post_meta( $model_array['id'], '_glb_file', true ));?>"> 
                                <input id="upload_glb_button" class="button nodisplay upload_glb_button" type="button" value="<?php echo esc_html(__(  'Upload', 'ar-for-woocommerce'));?>" />
                            </div>
                        ...
                        <div style="width:48%; float:left;">
                            <center>
                        	<strong><?php echo esc_html(__( 'USDZ/REALITY 3D Model', 'ar-for-woocommerce'));?> - <span class="ar_label_tip"><?php echo esc_html(__( 'Optional', 'ar-for-woocommerce'));?></span></strong><br><br>
                            ...
                            <div align="center">                            
                                <input type="hidden" pattern="https?://.+" title="<?php echo esc_html(__('Secure URLs only', 'ar-for-woocommerce')); ?> https://" placeholder="https://" name="_usdz_file" id="_usdz_file" class="regular-text ar_input_field" value="<?php echo esc_html(get_post_meta( $model_array['id'], '_usdz_file', true ));?>"> 
                                <input id="upload_usdz_button" class="button upload_usdz_button nodisplay" type="button" value="<?php echo esc_html(__( 'Upload', 'ar-for-woocommerce'));?>" />
                            </div>
                            </center>
                        </div>
                    </div>
                    ...
                    if($plan_check!='Premium') { 
                		    $premium_only = '<b> - '.esc_html(__('Premium Plans Only', 'ar-for-woocommerce')).'</b>'; 
                		    $disabled = ' disabled';
                ...
                $support_links = '';
                if (!$ar_whitelabel){
        		    $support_links = '<br><a href="admin.php?page=wc-settings&tab=ar_display">'.esc_html(__('AR Display Settings', 'ar-for-woocommerce')).'</a> | <a href="https://augmentedrealityplugins.com/support/" target="_blank">'.esc_html(__('Documentation', 'ar-for-woocommerce')).'</a> | <a href="https://augmentedrealityplugins.com/support/3d-model-resources/" target="_blank">'.esc_html(__('Sample 3D Models', 'ar-for-woocommerce')).'</a> | <a href="https://augmentedrealityplugins.com/support/3d-model-resources/#hdr" target="_blank">'.esc_html(__('Sample HDR Images', 'ar-for-woocommerce')).'</a> ';
        		}
        		/* User Upload */ ?>
            	<div id="user_upload_content" class="ar_tabcontent ar_tabcontent" style="padding:20px;">
		            <h3><?php echo esc_html(__( 'Allow user to upload their own image or model file?', 'ar-for-woocommerce'));?></h3>
            	<br><?php echo esc_html(__( 'Using the [ar-user-upload] shortcode displays an Image/Model upload button and an empty model viewer. Model files (gltf & glb) will be displayed in the model viewer and image files (jpg & png) will be converted to hanging artworks with the 3D Gallery Builder.', 'ar-for-woocommerce'));?>
            	<br>
            	...
            	<div id="instructions_content" class="ar_tabcontent">
                        ...
                        if (!$ar_whitelabel){
                		    echo '<p><a href="https://augmentedrealityplugins.com/support/" target="_blank">'.esc_html(__('Documentation', 'ar-for-woocommerce')).'</a> | <a href="https://augmentedrealityplugins.com/support/3d-model-resources/" target="_blank">'.esc_html(__('Sample 3D Models', 'ar-for-woocommerce')).'</a> | <a href="https://augmentedrealityplugins.com/support/3d-model-resources/#hdr" target="_blank">'.esc_html(__('Sample HDR Images', 'ar-for-woocommerce')).'</a> ';
                		}
                		?>
                		</p>
                </div>
