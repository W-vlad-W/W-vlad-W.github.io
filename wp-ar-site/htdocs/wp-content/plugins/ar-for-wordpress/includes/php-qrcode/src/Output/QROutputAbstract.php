...
abstract class QROutputAbstract implements QROutputInterface{
	...
	protected function saveToFile(string $data, string $file):bool{
		...
		if(!ar_wp_is_writable(dirname($file))){
			throw new QRCodeOutputException(sprintf('Could not write data to cache file: %s', esc_html($file)));
		}

		return (bool)ar_wp_custom_file_write($file, $data);
	}
