...
class AR_Model {
    ...
    public function get_model_array() {
        ...
        $model_array['ar_qr_destination_url']=get_post_meta( $atts['id'], '_ar_qr_destination'.$suffix, true );
        
        
        if ((isset($model_array['ar_css_override'])) AND (get_post_meta($atts['id'], '_ar_css_positions'.$suffix, true )!='')){
        ...
        if ((isset($model_array['ar_css_override'])) AND (get_post_meta($atts['id'], '_ar_css'.$suffix, true )!='')){
