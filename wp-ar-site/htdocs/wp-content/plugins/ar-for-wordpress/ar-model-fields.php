...
add_shortcode('ar-editor', 'ar_wp_model_fields_public');
                ...
                ?>
                    <div id="ar_shortcode_instructions">
                        ...
                        if ((substr(get_option('ar_licence_valid'),0,5)!='Valid')AND($model_count>=2)){?>
                            ...
                            <p><b><a href="edit.php?post_type=armodels&page"><?php esc_html_e( 'Please check your subscription & license key. If you are using the free version of the plugin then you have exceeded the limit of allowed models.', 'ar-for-wordpress' );?></a></b></p>
                    </div>
            </div>
        </div>
                        <?php
                ...
                <div class="ar_admin_viewer" id="ar_admin_options">
                    ...
                    <div id="ar_display_options_panel" class="ar_accordian_panel">
                        ...
                        <?php if ($public != 'y'){ ?>
                	        ...
                	        <div style="clear:both"></div>
                	        <!--<div class="ar_admin_label" style="width:100%"><label for="_ar_poster"><?php esc_html_e( 'Poster Image', 'ar-for-wordpress' ); echo '<span class="ar_label_tip"> - ';esc_html_e('JPG or PNG - Defaults to Featured Image', 'ar-for-wordpress' );?></span></label></div>
                            <div class="ar_admin_field"><input type="url" pattern="https?://.+" title="<?php esc_html_e('Secure URLs only','ar-for-wordpress'); ?> https://" placeholder="https://" name="_ar_poster" id="_ar_poster" class="regular-text" value="<?php echo esc_html(get_post_meta( $model_array['id'], '_ar_poster', true ));?>" <?php echo esc_html($disabled);?>> <input id="upload_poster_button" class="button upload_poster_button" type="button" value="<?php esc_html_e( 'Upload', 'ar-for-wordpress' );?>" <?php echo esc_html($disabled);?>/> <a href="#" onclick="document.getElementById('_ar_poster').value = ''"><img src="<?php echo esc_url( plugins_url( "assets/images/delete.png", __FILE__ ) );?>" style="width: 15px;vertical-align: middle;"></a></div>
                	        <div style="clear:both"></div>-->
                        ...
                        <?php 
                            if ($field=='_ar_autoplay'){
                                ...
                                <div id="animationDiv" style="display:none">
                        	        ...
                        	        <div class="ar_admin_field"><select name="_ar_animation_selection" id="_ar_animation_selection" class="ar-input ar-input-wide" <?php echo esc_html($disabled);?>>
                        	            <?php if ($ar_animation_selection !='' ){?><option selected value="<?php echo esc_html($ar_animation_selection); ?>"><?php echo esc_html($ar_animation_selection); ?></option><?php } ?>
                        	            </select></div>
